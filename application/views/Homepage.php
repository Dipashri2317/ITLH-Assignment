    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="/public/book1.jpg" alt="" width="500">
                <div class="carousel-caption">
                    <h1 style="font-size:400%;align:right">BEST SELLING BOOKS UPTO 20% OFF</h1>
                    <h4>Surround Yourself With BEST....!!</h4>
                </div>
            </div>
            <div class="item">
                <img src="/public/book2.jpg" alt="" width="450">
                <div class="carousel-caption">
                    <h1 style="font-size:400%;">BEST MARATHI LANGUAGE BOOKS</h1>
                    <h4>Right Here, Right Now....!!</h4>
                </div>
            </div>
            <div class="item">
                <img src="/public/book3.jpg" alt="" width="600">
                <div class="carousel-caption">
                    <h1 style="font-size:400%;">SCHOOL TEXTBOOK UPTO 40% OFF</h1>
                    <h4>EQUIP For BRIGHT Future....!!</h4>
                </div>
            </div>
        </div>
...
<div class="container">   
    <div class="row">
        <div class="row">
            <div class="col-md-9">
              <fieldset><legend><h2 style="color:white;">New Products</h2></legend></fieldset>
            </div>
            </div>
